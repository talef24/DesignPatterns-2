...
namespace AppLogic
{
	public sealed class AppManager
	{
		...
		public List<string> GetTasksOfChosenDate(DateTime i_Date)
		{
			List<string> tasksList = m_Calendar.GetTasksOfTheDay(i_Date);

			return tasksList;
		}

		public void RemoveTaskFromCalendar(DateTime i_Date, string i_Task)
		{
			m_Calendar.RemoveTask(i_Date.ToShortDateString(), i_Task);
		}

		public void AddTaskToCalendar(DateTime i_Date, string i_Task)
		{
			m_Calendar.AddTask(i_Date.ToShortDateString(), i_Task);
		}

		public void UpdatSettings(Point i_WindowLocation, Color i_PageColor, Color i_NameColor, Color i_ButtonsColor)
		{
